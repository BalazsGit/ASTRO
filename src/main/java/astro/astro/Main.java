...
import astro.astro.application.ApplicationsFrame;
import astro.astro.application.ApplicationsTabHeader;
import astro.astro.browser.BrowserFrame;
import astro.astro.browser.BrowserTabHeader;
import astro.astro.config.PropertyService;
import astro.astro.config.PropertyServiceImpl;
import astro.astro.config.Props;
import astro.astro.database.Database;
import astro.astro.mainframe.MainFrame;
import astro.astro.settings.GUISettings;
import astro.astro.texteditor.TextEditor;
import astro.astro.texteditor.TextEditorTabHeader;
import astro.astro.util.FlatTabbedPaneAddIcon;
import astro.astro.util.Reload;
